function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		--Check if the note is an H Note
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'H Note' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'HNote_assets'); --Change texture
